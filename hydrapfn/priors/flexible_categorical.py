...
from hydrapfn.utils import normalize_data, nan_handling_missing_for_unknown_reason_value, nan_handling_missing_for_no_reason_value, nan_handling_missing_for_a_reason_value, to_ranking_low_mem, remove_outliers, normalize_by_used_features_f
...
def get_batch(
    ...
    **kwargs
    ...
    sample = [
        model(batch_size=batch_size_per_gp_sample) 
